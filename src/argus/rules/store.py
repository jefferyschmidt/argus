...
class RuleStore:
    def __init__(self, db_path: Path | None = None) -> None:
        ...
        # other store that opens a connection to the same argus.db --
        # this store's own self._lock (used below, for every query/write)
        # only ever serialized threads within THIS connection, never
        # across those other connections (see db.py).
